...
| **Modèle servi (SFT v9)** | HF privé `ghislaindelabie/oc14-qwen3-1.7b-triage-sft` |
...
| 2 | **Modèle spécialisé SFT + LoRA** | `Delabie_Ghislain_2_Modele_SFT_LoRA_062026` | HF privé `…/oc14-qwen3-1.7b-triage-sft` (v9 fusionné 16-bit) · adapter LoRA · notebook Kaggle `oc14-sft-lora` | ✅ |
